...
| signed audit/transparency history | partial | Worker manifests and every signed platform resource are exposed through a redacted cluster audit; scoped one-way API tokens support Chinese console plus operator-signed CLI list/create/revoke; KV/D1 data-plane mutation export and archival remain |
