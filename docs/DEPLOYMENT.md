...
curl -fLo /tmp/install-randallflare-release.sh \
  https://raw.githubusercontent.com/RandallAnjie/RandallFlare/v0.8.0/infra/install-release.sh
bash /tmp/install-randallflare-release.sh \
  --version v0.8.0 --config /root/rf.toml --env /root/rf.env
```
...
curl -fLo /tmp/install-randallflare-release.sh \
  https://raw.githubusercontent.com/RandallAnjie/RandallFlare/v0.8.0/infra/install-release.sh
sudo bash /tmp/install-randallflare-release.sh --version v0.8.0
```
